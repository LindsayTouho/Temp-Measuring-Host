...
#include "../../rebuild/settingWindow.h"
...
QT_MOC_LITERAL(3, 30, 10), // "QSettings*"
QT_MOC_LITERAL(4, 41, 10), // "newSetting"
QT_MOC_LITERAL(5, 52, 6) // "Change"

    },
    "SettingWindow\0settingChanged\0\0QSettings*\0"
    "newSetting\0Change"
};
...
void SettingWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->settingChanged((*reinterpret_cast< QSettings*(*)>(_a[1]))); break;
        ...
        {
            typedef void (SettingWindow::*_t)(QSettings * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingWindow::settingChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingWindow::settingChanged(QSettings * _t1)
{
